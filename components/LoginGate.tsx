  ...
  return (
    <div className="w-full max-w-md animate-fade-in relative z-10">
      <div className="text-center mb-6 relative">
        ...
        <p className="text-[8px] font-bold text-blue-500 uppercase tracking-[0.5em] animate-pulse">Terminal Handshake Required</p>
      </div>

      <form onSubmit={handleSubmit} className="glass p-8 rounded-[2rem] border border-white/10 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] space-y-6 relative overflow-hidden group">
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            <input 
              ...
              className={`w-full bg-slate-950/80 border ${error ? 'border-red-500' : 'border-white/10'} rounded-xl px-6 py-4 text-center text-base tracking-[0.4em] text-white focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all placeholder:tracking-normal placeholder:text-[9px] placeholder:font-black placeholder:uppercase placeholder:text-slate-800`}
            />
          </div>
        </div>
